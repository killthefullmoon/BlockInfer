...
def set_context(run_type, cu_seqlens_q=None, cu_seqlens_k=None, max_seqlen_q=0, max_seqlen_k=0, slot_mapping=None, context_lens=None, block_tables=None, is_last_denoise_step=None, block_length=4):
    global _CONTEXT
    if is_last_denoise_step is None:
        is_last_denoise_step = [False]
